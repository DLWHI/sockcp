...
::sockaddr_in make_sockaddr(const char *ip, int port) noexcept
{
  ::sockaddr_in sin;
...
static const std::vector<::sockaddr_in> test_pool = {
    make_sockaddr("127.0.0.1", 4483),
    make_sockaddr("192.168.11.253", 4483),
    make_sockaddr("127.0.0.1", 0),
    make_sockaddr("78.105.61.33", 1337),
    make_sockaddr("63.123.243.23", 0),
    make_sockaddr("255.255.255.0", 0),
};
